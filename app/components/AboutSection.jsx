...
const TAB_DATA = [
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>Sepuluh Nopember Institute of Technology</li>
        <li>SMAN 3 Kuningan</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>Government-Funded Independent Study, Startup Campus–Data Science and AI</li>
        <li>Udemy C Programming For Beginners</li>
      </ul>
    ),
  },
];
  ...
  return (
    <section className="text-white" id="about">
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        <Image src="/images/rifqi-about.jpg" width={500} height={500} />
